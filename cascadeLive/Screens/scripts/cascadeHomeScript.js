...
window.onload = function () {
    ...
    setInterval(function () { cascadeIntro(); }, 2000);
};
...
//this function is the bouncing motto animation 
function cascadeIntro() {
    let message = ["Proactive.", "Predictive.", "Powerful.", "Cascade API"];
    document.getElementById("cascade-intro").innerText = message[c];
    c++;
    if (c >= message.length) {
        c = 0;
    }
